...
class ImageViewer():
    ...
    def clear_info(self):           # clear and hide widgets whenever another image has been viewed
        ...
        self.window["-transformed_image-"].update('')     
    ...
    def image_open(self, file):   # function for opening an image
        ...
        if(file_name.split(".")[1] != "pcx"):    # check if image is not in PCX format
            ...
            with open(file, 'rb') as f:     # read the image as binary
                ...
                self.window["-colorpalette-"].update("color_palette.png")     # save and show the color palette
                ...
                self.window["-IMAGE-"].update("tmp.png")     # save and show the image
